...
function AccountCreation() {
    ...
    useEffect(() => {
        if (validName === false) {
            setErrMsg(
                "Usernames must start with a letter, be 3 to 20 characters long, and only contain letters, numbers, and ('-', '_') characters."
            )
            ...
            <div className="form-container full-height">
                <div id="form-one-block">
                    ...
                    >
                        ...
                        >
                            9 to 24 characters and it must include a letter and
                            a number.
                        </p>
                        <br />
                        <label htmlFor="password">
